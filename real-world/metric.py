"""
Metrics for evaluating the performance. (Recall & DCG)
"""
import pickle
import numpy as np
...
def dcg_at_k(obj: Dataset, score, eval=True):
    """
...
def recall_at_k(obj: Dataset, score, eval=True):
    """
...
if __name__ == '__main__':
    file = open("data/coat/coat.data", "rb")
